...
const quizData = {
  ...
  questions: [
    ...
    {
      id: 2,
      question: "Quelle est la bonne façon de passer des données d'un parent à un enfant?",
      options: [
        { id: "a", text: "Via des props" },
        { id: "b", text: "Via des refs" },
        { id: "c", text: "Via des hooks" },
        { id: "d", text: "Via localStorage" }
      ],
      correctAnswer: "a"
    },
    {
      ...
      options: [
        { id: "a", text: "S'exécute à chaque render" },
        { id: "b", text: "S'exécute une seule fois au montage" },
        { id: "c", text: "Ne s'exécute jamais" },
        { id: "d", text: "S'exécute au démontage" }
      ],
      correctAnswer: "b"
    },
    {
      id: 4,
      question: "Quelle bibliothèque de routage est couramment utilisée avec React?",
      options: [
        { id: "a", text: "React Router" },
        { id: "b", text: "Vue Router" },
        { id: "c", text: "Angular Router" },
        { id: "d", text: "Express Router" }
      ],
      correctAnswer: "a"
    }
  ]
